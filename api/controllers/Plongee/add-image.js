...
module.exports = {
	...
	description: 'Add a new image to plongees',
	...
	exits: {
		...
		success: {
			description: 'Image associer au plongee.'
		},
		tooBig: {
	...
	fn: async function ({ idplongee, image }) {
		...
		const result = await Plongee.addToCollection(idplongee, 'images').members([createdImage.id])
		createdImage.plongee = idplongee
		return createdImage
