...
module.exports = {
	...
	description: 'Add a new logo to jeu',
	...
	exits: {
		...
		success: {
			description: 'logo associer au jeu.'
		},
		tooBig: {
	...
	fn: async function ({ idjeu, image }) {
		...
		const result = await Jeu.addToCollection(idjeu, 'logos').members([createdImage.id])
