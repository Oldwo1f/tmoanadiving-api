...
module.exports = {
	...
	friendlyName: 'Add Image fin',


	description: 'Add a new image to jeu',
	...
	exits: {
		...
		success: {
			description: 'Image associer au jeu.'
		},
		tooBig: {
	...
	fn: async function ({ idjeu, image }) {
		...
		console.log('ADD imagesgagnant');
		console.log('createdImage ', createdImage);
		const result = await Jeu.addToCollection(idjeu, 'imagesgagnant').members([createdImage.id])
		createdImage.jeu = idjeu
		return createdImage
