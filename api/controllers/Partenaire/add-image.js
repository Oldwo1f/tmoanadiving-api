...
module.exports = {
	...
	description: 'Add a new image to partenaires',
	...
	exits: {
		...
		success: {
			description: 'Image associer au partenaire.'
		},
		tooBig: {
	...
	fn: async function ({ idpartenaire, image }) {
		...
		const result = await Partenaire.addToCollection(idpartenaire, 'images').members([createdImage.id])
		createdImage.partenaire = idpartenaire
		return createdImage
