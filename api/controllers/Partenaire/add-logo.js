...
module.exports = {
	...
	description: 'Add a new logo to partenaires',
	...
	exits: {
		...
		success: {
			description: 'logo associer au partenaire.'
		},
		tooBig: {
	...
	fn: async function ({ idpartenaire, image }) {
		...
		const result = await Partenaire.addToCollection(idpartenaire, 'logos').members([createdImage.id])
		createdImage.partenairelogo = idpartenaire
		return createdImage
